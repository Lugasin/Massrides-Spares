...
BEGIN
  ...
  (
    ...
    ARRAY['/src/assets/farmer-tractor.jpg'],
    '{"innerDiameter": "1/2 inch", "length": "36 inches", "workingPressure": "3000 PSI", "fittingType": "JIC", "temperature": "-40Â°F to +212Â°F"}'::jsonb,
    ARRAY['Universal'],
    '12 months', false,
  ...
  (
    vendor2_id, cooling_cat_id,
    'Engine Thermostat 180Â°F',
    'Engine thermostat for optimal operating temperature. 180Â°F opening temperature with housing included.',
    'THERMOSTAT-001', NULL,
    'Gates', 35.00, 'new', 'in_stock', 95, 25,
    ARRAY['/src/assets/hero-combine.jpg'],
    '{"openingTemp": "180Â°F", "diameter": "2 inches", "type": "Wax pellet", "housing": "Included"}'::jsonb,
