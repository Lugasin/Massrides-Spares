...
const slides: CarouselSlide[] = [
  {
    ...
    description: 'Discover our extensive range of tractors, harvesters, and farming machinery designed for modern agriculture.',
    cta: 'Shop Tractors',
    link: '/catalog?category=tractors',
    type: 'image'
  },
  {
    id: 2,
    ...
    description: 'Get the best combine harvesters and harvesting equipment for maximum efficiency and yield.',
    cta: 'Shop Harvesters',
    link: '/catalog?category=harvesters',
    type: 'image'
  },
  {
    id: 3,
    ...
    description: 'Explore our smart irrigation solutions including center pivots and sprinkler systems.',
    cta: 'Shop Irrigation',
    link: '/catalog?category=irrigation',
    type: 'image'
  },
  {
    id: 4,
    image: farmerTractor,
    title: 'Spring Equipment Sale',
    description: 'Save up to 25% on selected equipment. Limited time offer on premium agricultural machinery.',
    cta: 'View Sale Items',
  ...
  },
  {
    ...
    title: 'Your Farming Future Starts Here',
    description: 'Partner with industry leaders like John Deere, Case IH, and more for reliable agricultural solutions.',
    cta: 'Explore Brands',
    link: '/catalog',
    type: 'image'
  }
