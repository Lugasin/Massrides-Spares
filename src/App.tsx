      ...
      <TooltipProvider>
        ...
        <BrowserRouter future={{ v7_relativeSplatPath: true, v7_startTransition: true }}>
          ...
          <Suspense fallback={<PageLoader />}>
            ...
            <Route path="/vendor/inventory" element={<ProtectedRoute allowedRoles={['vendor', 'admin', 'super_admin']} element={<VendorInventory />} />} />
            <Route path="/vendor/add-product" element={<ProtectedRoute allowedRoles={['vendor', 'admin', 'super_admin']} element={<AddProduct />} />} />
            <Route path="/vendor/edit-product/:productId" element={<ProtectedRoute allowedRoles={['vendor', 'admin', 'super_admin']} element={<AddProduct />} />} />
            ...
            <Route path="/profile/vendor" element={<ProtectedRoute allowedRoles={['vendor']} element={<VendorDashboard />} />} />
